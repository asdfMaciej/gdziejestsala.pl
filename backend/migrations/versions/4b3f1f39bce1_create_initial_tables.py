...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['from_point_id'], ['points.id'], ),
    sa.ForeignKeyConstraint(['to_point_id'], ['points.id'], ),
    ...
    sa.ForeignKeyConstraint(['map_image_id'], ['images.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_floors_id'), 'floors', ['id'], unique=False)
    op.create_table('floor_points',
    sa.Column('id', sa.Integer(), nullable=False),
